...
public class SilverOreBlock extends GeneralLifeModElements.ModElement {
	@ObjectHolder("general_life:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(GeneralLifeModElements instance) {
		super(instance, 20);
	}
