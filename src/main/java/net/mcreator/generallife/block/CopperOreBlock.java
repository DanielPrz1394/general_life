...
public class CopperOreBlock extends GeneralLifeModElements.ModElement {
	@ObjectHolder("general_life:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(GeneralLifeModElements instance) {
		super(instance, 8);
	}
