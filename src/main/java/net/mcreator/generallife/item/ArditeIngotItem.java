...
public class ArditeIngotItem extends GeneralLifeModElements.ModElement {
	@ObjectHolder("general_life:ardite_ingot")
	public static final Item block = null;
	public ArditeIngotItem(GeneralLifeModElements instance) {
		super(instance, 34);
	}
