...
public class ArditeDustItem extends GeneralLifeModElements.ModElement {
	@ObjectHolder("general_life:ardite_dust")
	public static final Item block = null;
	public ArditeDustItem(GeneralLifeModElements instance) {
		super(instance, 40);
	}
