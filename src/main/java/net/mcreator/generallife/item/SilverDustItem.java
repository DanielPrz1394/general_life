...
public class SilverDustItem extends GeneralLifeModElements.ModElement {
	@ObjectHolder("general_life:silver_dust")
	public static final Item block = null;
	public SilverDustItem(GeneralLifeModElements instance) {
		super(instance, 28);
	}
