...
public class SilverIngotItem extends GeneralLifeModElements.ModElement {
	@ObjectHolder("general_life:silver_ingot")
	public static final Item block = null;
	public SilverIngotItem(GeneralLifeModElements instance) {
		super(instance, 22);
	}
